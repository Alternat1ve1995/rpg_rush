   ...
   void CheckInput()
   {
      ...
      if (Input.GetKeyDown(KeyCode.Keypad0))
      {
         ...
         if (slots[0].skill != null)
            slots[0].skill.ExecuteSkill(player, null, Vector3.zero);
      }
      else if (Input.GetKeyDown(KeyCode.Keypad1))
      {
         Debug.Log("Skill 1 triggered");
         if (slots[1].skill != null)
            slots[1].skill.ExecuteSkill(player, null, Vector3.zero);
      }
      ...
      else if (Input.GetKeyDown(KeyCode.Keypad2))
      {
         ...
         if (slots[2].skill != null)
            slots[2].skill.ExecuteSkill(player, null, Vector3.zero);
      }
      else if (Input.GetKeyDown(KeyCode.Keypad3))
      {
         Debug.Log("Skill 3 triggered");
         if (slots[3].skill != null)
            slots[3].skill.ExecuteSkill(player, null, Vector3.zero);
      }
      else if (Input.GetKeyDown(KeyCode.Keypad4))
      {
         Debug.Log("Skill 4 triggered");
         if (slots[4].skill != null)
            slots[4].skill.ExecuteSkill(player, null, Vector3.zero);
      }
      else if (Input.GetKeyDown(KeyCode.Keypad5))
      {
         Debug.Log("Skill 5 triggered");
         if (slots[5].skill != null)
            slots[5].skill.ExecuteSkill(player, null, Vector3.zero);
      }
